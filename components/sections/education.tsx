  ...
  return (
    <section id="education" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        >
          <div className="relative glass-strong rounded-3xl p-8 md:p-10 glow-border hover:glow-purple transition-shadow">
            <div className="absolute -top-6 left-8 p-4 rounded-2xl glass-strong glow-purple">
